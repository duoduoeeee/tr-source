...
现在，从主屏幕下拉仍然显示的是spotlight搜索栏（以及建议的应用程序）。而搜索栏还存在于你主屏左边专门的搜索页（见动图）。而这个专门的搜索页中还包含了Siri建议的应用和联系人，而它还和地图功能做结合来显示当地的兴趣热点（nearby）。有些推荐颇为不着边际——但是我还是频繁地使用“加油站位置”功能——比我所愿意承认的次数多得多。（在nearby）下面你则会看见
