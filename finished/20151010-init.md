...
每次系统升级，Siri都会学到一点点新技能，而这一次，它在学到新技能的同时，外观也得到了更新。新的Siri界面上采用了更为友好的彩色声音波形图（从苹果表上直接搬来的），它会随着你说话的声音波动起伏。而更为重要的是，现在由于采用了一些新的上下文分析技术，Siri的表现更像是你地地道道的左膀右臂。你可以直接在Safari里浏览网页的时候
